...
Widget dataTable(context, List<HiringModel> listModel){
  return Expanded(child: DataTable2(
    ...
    columns: [
      ...
      DataColumn2(label: Center(child: Text('Phone Number')), fixedWidth: 210),
...
Widget dataTableSafety(context, List<HiringModel> listModel){
  return Expanded(child: DataTable2(
    ...
    columns: [
      ...
      DataColumn2(label: Center(child: Text('Code')), fixedWidth: 180),
      DataColumn2(label: Center(child: Text('Depart')),  fixedWidth: 150),
      DataColumn2(label: Center(child: Text('Safety')),  fixedWidth: 150),
      DataColumn2(label: Center(child: Text('Crocs')), fixedWidth: 150),
      DataColumn2(label: Center(child: Text('vest')), fixedWidth: 150),
      ...
      DataRow(
        ...
        cells: [
          ...
          DataCell(Center(child: Text('${listModel[index].project}',))),
          DataCell(Center(child: Text('${listModel[index].safety}',style: TextStyle(),))),
