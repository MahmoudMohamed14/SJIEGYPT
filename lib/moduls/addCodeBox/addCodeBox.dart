...
class  AddCodeBox extends StatelessWidget {
      ...
      builder: (context,state){
        ...
        return Scaffold(
            appBar: AppBar(
              ...
              title: const Text("upload code Box",
            ...
            body: cubit.listBox.isNotEmpty?SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemCount: cubit.listBox.length,
                      ...
                      itemBuilder: (context, index) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                Expanded(child: Center(child: Text("${cubit.listBox[index][0]}"))),


                                Expanded(child: Text("${cubit.listBox[index][1]}")),
                    ...
                    cubit.listBox.isNotEmpty ? Column(
                      children: [
